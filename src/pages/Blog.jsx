              ...
              <div className="p-8 lg:p-12 flex flex-col justify-center">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="flex items-center space-x-2 text-primary-500 hover:text-primary-600 font-semibold transition-colors"
                  >
                    <span>Read More</span>
                    <ArrowRight size={20} />
                  </Link>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                    ...
                    <span className="text-primary-500 group-hover:text-primary-600 font-semibold text-sm flex items-center space-x-1 transition-colors">
                      <span>Read</span>
                      <ArrowRight size={16} />
                    </span>
                  </div>
