          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                for over 20 years. We specialize in creating premium residential and commercial 
              ...
              <p className="text-lg text-gray-600">
                With a portfolio of over 30 successfully completed projects and more than 700 
